...
<table border="1">
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="../Views/View_put_kelas.php?id_kelas=<?php echo base64_encode($Get['id_kelas']) ?>"><img src = "../img/eye.png" style = "width : 40px"></a>
                    <a button onclick="konfirmasi(<?php echo $Get['id_kelas'] ?>)"><img src = "../img/Trash.png" style = "width : 40px"></a>
                </td>
            </tr>
    <?php
        }
