...
<table border="1">
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="../Views/View_put_spp.php?id_spp=<?php echo base64_encode($Get['id_spp']) ?>"><img src= "../img/Eye.png" style = "width : 40px"></a>
                    <a onclick="konfirmasi(<?php echo $Get['id_spp'] ?>)"><img src="../img/Trash.png" style="width:40px"></a>
                </td>
            </tr>
    <?php
        }
