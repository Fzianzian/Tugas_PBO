...
<table border="1">
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="../Views/View_put_siswa.php?nisn=<?php echo base64_encode($Get['nisn']) ?>"><img src="../img/Eye.png" style="width: 40px"></a>
                    <a onclick="konfirmasi(<?php echo $Get['nisn'] ?>)"><img src ="../img/Trash.png" style="width:40px"></a>
            </tr>
    <?php
        }
    }
